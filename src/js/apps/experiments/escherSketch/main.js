...
class Main {
  ...
  generateDisk( tiling ) {
    ...
    const meshA = new THREE.Mesh( geometries[0], this.pattern[tiling[0].materialIndex] );
    const meshB = new THREE.Mesh( geometries[1], this.pattern[tiling[1].materialIndex] );
